...
{#if toast.active}
    ...
    <div
        class="fixed z-[100] pointer-events-none {isCursor
            ? ''
        ...
        <div
            class="px-4 py-4 bg-[var(--ui-card)] border border-[var(--ui-border)] text-[var(--ui-text)] rounded-lg shadow-xl font-bold uppercase tracking-wider text-xs {isCursor
                ? 'animate-scale-in'
                : 'animate-slide-up'}">
